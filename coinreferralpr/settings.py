"""
Django settings for coinreferralpr project.
...
SECRET_KEY = 'django-insecure-dn!*hud6y2!@#187j-=r5njxtopbm4ggys%s&-wm18(o^$fr$3'
...
ROOT_URLCONF = 'coinreferralpr.urls'
...
WSGI_APPLICATION = 'coinreferralpr.wsgi.application'
